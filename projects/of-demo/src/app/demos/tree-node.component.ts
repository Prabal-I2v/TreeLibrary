...
import { Node, I2vTree } from 'i2v-tree';
...
export class TreeNodeComponent {
     ...
     */
    public readonly treeModel = input.required<I2vTree<TreeDataModel>>();
     ...
     *
     * Deliberately not I2vTree.isExpandable(), which falls back to "has loaded
